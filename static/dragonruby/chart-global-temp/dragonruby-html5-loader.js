var GDragonRubyGameId = 'chart-global-temp';
var GDragonRubyGameTitle = 'Chart Global Temp';
var GDragonRubyDevTitle = 'Jase Magee Limited';
...
var Module = {
  ...
  startClickToPlay: function() {
    ...
    var base64 = btoa(String.fromCharCode.apply(null, icondata));
    ...
    p.textContent = 'Click or tap to play!';
    p.style.textAlign = 'center';
    p.style.backgroundColor = '#FF0000';
    p.style.color = '#FFFFFF';
    p.style.width = '100%';
  ...
  preRun: function() {
    ...
    FS.syncfs(true, function(err) {
      ...
      loadDataFiles(GDragonRubyGameId, 'gamedata/', function() {
        ...
        setTimeout(function() { Module.setStatus(""); }, 5000);
